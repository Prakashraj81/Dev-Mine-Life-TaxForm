                        ...
                        {StepTwo && (
                            ...
                            <Fragment>
                                <List disablePadding>
                                    ...
                                    <ListItem>
                                    <ListItemText primary="電話番号" secondary={TelephoneNumber ? TelephoneNumber : "提供されていない"} />
                                    {TelephoneNumber ?
                                    <ListItemIcon className="text-custom-black">
                                    <EditIcon id={"TelephoneNumber"}  onClick={handleBack}/>
                                    </ListItemIcon>
                                    :<></>}
                                    </ListItem>
                                    ...
                                    <ListItem>
                                    <ListItemText primary="被相続人との間柄" secondary={RelationshipWithDecedent ? RelationshipWithDecedent : "提供されていない"} />
                                    {RelationshipWithDecedent ?
                                    <ListItemIcon className="text-custom-black">
                                    <EditIcon id={"RelationshipWithDecedent"}  onClick={handleBack}/>
                                    </ListItemIcon>
                                    :<></>}
                                    </ListItem>
                                    ...
                                    <ListItem>
                                    <ListItemText primary="障害者控除" secondary={DisabledRadioValue ? DisabledRadioValue : "提供されていない"} />
                                    {DisabledRadioValue ?
                                    <ListItemIcon className="text-custom-black">
                                    <EditIcon id={"DisabledRadioValue"}  onClick={handleBack}/>
                                    </ListItemIcon>
                                    :<></>}
                                    </ListItem>
                                    ...
                                    <ListItem>
                                    <ListItemText primary="法定相続人ですか？" secondary={LegalHeirRadioValue ? LegalHeirRadioValue : "提供されていない"} />
                                    {LegalHeirRadioValue ?
                                    <ListItemIcon className="text-custom-black">
                                    <EditIcon id={"LegalHeirRadioValue"}  onClick={handleBack}/>
                                    </ListItemIcon>
                                    :<></>}
                                    </ListItem>
