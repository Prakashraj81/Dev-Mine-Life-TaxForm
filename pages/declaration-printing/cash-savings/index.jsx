        ...
        <>
            ...
            <Box className="cash-savings-wrapper">
                ...
                <Box className="cash-list py-3">
                    <Table aria-label="cash savings table">
                        <TableBody>
                            {cashSavingsList.map((list, index) => (
                                <TableRow key={index} className="border border-light-gray">
                                    ...
                                    <TableCell sx={{ width: 250, padding: '8px', border: '1px solid lightgray' }}>{list.deposit_type}</TableCell>
                ...
                <Box className="w-full inline-block text-left pt-3">
                    <AddPageButton pageLink={"/declaration-printing/cash-savings/cash-savings-add"} />
                </Box>
