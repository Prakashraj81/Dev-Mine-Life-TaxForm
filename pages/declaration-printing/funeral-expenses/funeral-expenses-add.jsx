                ...
                <form action="#" method="POST">
                    ...
                    {StepTwo && (
                            ...
                            <Fragment>
                                <List disablePadding>
                                    <ListItem>
                                    <ListItemText primary="費用支払先氏名" secondary={FeePayeeName ? FeePayeeName : "提供されていない"} />
                                    {FeePayeeName ?
                                    <ListItemIcon className="text-custom-black">
                                    <EditIcon id={"FeePayeeName"} onClick={handleBack}/>
                                    </ListItemIcon>
                                    :<></>}
                                    </ListItem>
                                    ...
                                    <ListItem>
                                    <ListItemText primary="支払った日" secondary={DatePaid ? DatePaid : "提供されていない"} />
                                    {DatePaid ?
                                    <ListItemIcon className="text-custom-black">
                                    <EditIcon id={"DatePaid"}  onClick={handleBack}/>
                                    </ListItemIcon>
                                    :<></>}
                                    </ListItem>
                                    ...
                                    <ListItem>
                                    <ListItemText primary="支払った金額" secondary={AmountPaid ? AmountPaid : "提供されていない"} />
                                    {AmountPaid ?
                                    <ListItemIcon className="text-custom-black">
                                    <EditIcon id={"AmountPaid"}  onClick={handleBack}/>
                                    </ListItemIcon>
                                    :<></>}
                                    </ListItem>
