                    ...
                    <form action="#" method="POST">
                        ...
                        {StepTwo && (
                            ...
                            <Fragment>
                                <List disablePadding>
                                    <ListItem>
                                    <ListItemText primary="勤務先会社の名称" secondary={NameoftheCompany ? NameoftheCompany : "提供されていない"} />
                                    {NameoftheCompany ?
                                    <ListItemIcon className="text-custom-black">
                                    <EditIcon id={"NameoftheCompany"}  onClick={handleBack}/>
                                    </ListItemIcon>
                                    :<></>}                                    
                                    </ListItem>
                                    ...
                                    <ListItem>
                                    <ListItemText primary="受け取った金額" secondary={AmountReceived ? AmountReceived : "提供されていない"} />
                                    {AmountReceived ?
                                    <ListItemIcon className="text-custom-black">
                                    <EditIcon id={"AmountReceived"}  onClick={handleBack}/>
                                    </ListItemIcon>
                                    :<></>}
                                    </ListItem>
