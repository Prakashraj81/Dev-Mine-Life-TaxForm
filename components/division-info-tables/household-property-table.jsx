...
export default function HouseholdPropertyTable() {
  ...
  return (
    <>
      ...
      <Table aria-label="collapsible table">
        <TableHead>
            <TableRow>
                <TableCell className="border border-light-gray border-l bg-table-light" align="left" colSpan={5}><span className="font-semibold">家庭用財産</span></TableCell>
            </TableRow>   
          <TableRow>            
            <TableCell className="border border-light-gray border-l bg-table-gray">財産の内容</TableCell>
