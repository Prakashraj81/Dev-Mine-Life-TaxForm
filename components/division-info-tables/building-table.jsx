  ...
  return (
    <>
      ...
      <Table aria-label="collapsible table">
        <TableHead>
            <TableRow>
                <TableCell className="border border-light-gray border-l bg-table-light" align="left" colSpan={5}><span className="font-semibold">建物</span></TableCell>
            </TableRow>   
          <TableRow>            
            <TableCell className="border border-light-gray border-l bg-table-gray">所在</TableCell>
            <TableCell className="border border-light-gray border-l bg-table-gray">床面積</TableCell>
        ...
        <TableCell className="border border-light-gray border-l" align="left"></TableCell>   
        <TableCell className="border border-light-gray border-l" align="left"></TableCell>   
