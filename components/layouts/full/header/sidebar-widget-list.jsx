      ...
      <Box className="sidebar-widget-list">
        ...
        <Box className="sidebar-list">
          {RecentSaveList.map((lists, index) => {
            ...
            let propertyActivity1 = lists.activity_message.startsWith('Cash Deposit');
            let propertyActivity2 = lists.activity_message.startsWith('Securities');
            let propertyActivity3 = lists.activity_message.startsWith('Building');
            let propertyActivity4 = lists.activity_message.startsWith('Land');
            let propertyActivity5 = lists.activity_message.startsWith('Household Details');
            let propertyActivity6 = lists.activity_message.startsWith('Death Benefit');
            let propertyActivity7 = lists.activity_message.startsWith('Death Retirement');
            let propertyActivity8 = lists.activity_message.startsWith('Other Property');
            let propertyActivity9 = lists.activity_message.startsWith('Debt');
            let propertyActivity10 = lists.activity_message.startsWith('Funeral Expenses');
            let propertyActivity11 = lists.activity_message.startsWith('Living Donation');
